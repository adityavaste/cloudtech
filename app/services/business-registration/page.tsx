    ...
    <MainLayout>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-section-alt">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl font-bold text-foreground mb-6 text-center">Our Registration Services</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {dedicatedServices.map((service, i) => (
              <Link key={i} href={service.href}>
                <div className="h-full bg-white rounded-xl p-6 border border-border hover:shadow-lg hover:shadow-blue-100/50 hover:border-accent transition-smooth hover:-translate-y-1 cursor-pointer">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-card">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            {[
              { title: 'Consultation', desc: 'We review your business type and recommend appropriate registrations.' },
              { title: 'Documentation', desc: 'We help you gather all required documents and information.' },
              { title: 'Filing', desc: 'Our experts prepare and file all applications with authorities.' },
              { title: 'Follow-up', desc: 'We handle all correspondence and approvals.' },
              { title: 'Delivery', desc: 'You receive all certificates and documents in hand.' },
            ].map((step, i) => (
